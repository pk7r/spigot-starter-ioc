...
public class SenderUtils {
    ...
    /**
     * Return the {@link org.bukkit.command.CommandSender} associated to the {@param id}, normally used with {@link dev.pk7r.spigot.starter.core.util.SenderUtils#getSenderId}
     *
